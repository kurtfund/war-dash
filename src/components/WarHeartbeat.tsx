        ...
        >
            ...
            >
                ...
                <div className="relative w-64 h-64 rounded-full flex flex-col items-center justify-center group-hover:brightness-125 transition-all overflow-hidden border border-[#061114] shadow-[inset_0_0_50px_rgba(0,0,0,0.9),0_0_50px_rgba(6,182,212,0.15)] ring-1 ring-cyan-500/20">
                    ...
                    {/* Deep Backing */}
                    <div className="absolute inset-0 bg-[#02080a]/95 backdrop-blur-xl z-0"></div>

                    {/* Swirling Smoke Layer 1 */}
                    <div className="absolute -inset-4 z-0 opacity-50 bg-[radial-gradient(ellipse_at_30%_30%,_rgba(6,182,212,0.3),_transparent_60%)] animate-[spin_4s_linear_infinite] blur-xl scale-150 mix-blend-screen origin-[40%_60%]"></div>

                    {/* Swirling Smoke Layer 2 */}
                    <div className="absolute -inset-4 z-0 opacity-30 bg-[conic-gradient(at_center,_rgba(6,182,212,0.4)_0%,_transparent_30%,_rgba(6,182,212,0.1)_60%,_transparent_100%)] animate-[spin_7s_linear_infinite_reverse] blur-xl mix-blend-screen scale-[2.0]"></div>
