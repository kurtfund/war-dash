...
function runCronJobs(io) {
    ...
    const rssFeeds = [
        { url: 'https://news.google.com/rss/search?q=tehran+iran+explosion+OR+strike+OR+missile&hl=en-US&gl=US&ceid=US:en', country: 'IRAN', name: 'OSINT: Tehran', weight: 1.0, perspective: 'Western' },
        { url: 'https://news.google.com/rss/search?q=qatar+doha+missile+intercepted+OR+explosion&hl=en-US&gl=US&ceid=US:en', country: 'QATAR', name: 'OSINT: Qatar', weight: 0.9, perspective: 'Western' },
        { url: 'https://news.google.com/rss/search?q=houthi+intercepted+OR+missile+red+sea&hl=en-US&gl=US&ceid=US:en', country: 'YEMEN (HOUTHI)', name: 'OSINT: Red Sea', weight: 0.9, perspective: 'Western' },
        { url: 'https://news.google.com/rss/search?q=centcom+intercepted+missile+OR+drone+middle+east&hl=en-US&gl=US&ceid=US:en', country: 'USA (CENTCOM)', name: 'OSINT: CENTCOM', weight: 0.9, perspective: 'Western' },
        { url: 'https://news.google.com/rss/search?q=uae+dubai+missile+OR+drone+intercepted&hl=en-US&gl=US&ceid=US:en', country: 'UAE', name: 'OSINT: UAE', weight: 0.9, perspective: 'Western' },
        // Global News Sources
        { url: 'https://www.reutersagency.com/feed/?best-topics=world-news&post_type=best', country: 'USA', name: 'Reuters World', weight: 0.8, perspective: 'Western' },
        { url: 'https://apnews.com/hub/world-news.rss', country: 'USA', name: 'AP News', weight: 0.8, perspective: 'Western' },
        { url: 'https://rss.nytimes.com/services/xml/rss/nyt/World.xml', country: 'USA', name: 'NYT World', weight: 0.7, perspective: 'Western' },
        { url: 'https://www.aljazeera.com/xml/rss/all.xml', country: 'QATAR', name: 'Al Jazeera', weight: 0.7, perspective: 'Global' },
        { url: 'http://feeds.bbci.co.uk/news/world/rss.xml', country: 'UK', name: 'BBC World', weight: 0.7, perspective: 'Western' },
        { url: 'https://www.rt.com/rss/news/', country: 'RUSSIA', name: 'RT News (Breaking)', weight: 0.8, perspective: 'Non-Western' },
        { url: 'https://www.rt.com/rss/middle-east/', country: 'RUSSIA', name: 'RT Middle East', weight: 0.8, perspective: 'Non-Western' },
        { url: 'https://search.cnbc.com/rs/search/view.xml?partnerId=2000&keywords=world', country: 'USA', name: 'CNBC World', weight: 0.7, perspective: 'Western' },
        { url: 'https://news.un.org/feed/subscribe/en/news/topic/peace-and-security/feed/rss.xml', country: 'UN', name: 'UN News: Peace & Security', weight: 0.8, perspective: 'Global' }
    ];
    ...
    const fetchRSS = async () => {
            ...
            try {
                ...
                if (feed && feed.items) {
                    return feed.items.slice(0, 15).map(item => {
                        ...
                        let type = 'kinetic'; // Default
                        if (lowerContent.includes('troop') || lowerContent.includes('deployment') || lowerContent.includes('irgc') || lowerContent.includes('idf') || lowerContent.includes('drill')) {
                            type = 'military';
                        } else if (lowerContent.includes('flight') || lowerContent.includes('airspace') || lowerContent.includes('aviation')) {
                            type = 'flight';
                        }
        ...
        const luaItemsWithType = luaItems.map(item => ({
            ...item,
            perspective: 'Diverse',
            type: item.raw_content.toLowerCase().includes('flight') ? 'flight' : (item.raw_content.toLowerCase().includes('military') ? 'military' : 'kinetic')
        }));
        newItems = [...newItems, ...luaItemsWithType];
        ...
        if (newItems.length > 0) {
            ...
            // Inject dynamic FlightRadar24 x.com telemetry
            const fr24Alerts = [
                {
                    id: `osint-fr24-${Date.now()}-1`,
                    source_country: 'FLIGHTRADAR24',
                    source_name: 'X.COM / @flightradar24',
                    perspective: 'Western',
                    type: 'flight',
                    raw_content: 'URGENT: GPS jamming and signal interference detected over UAE and Qatar airspace. Multiple commercial vectors reporting navigation anomalies.',
                    translated_content: 'GPS jamming and signal interference detected over UAE/Qatar.',
                    importance_weight: 1.0,
                    url: 'https://x.com/flightradar24/status/2030125153426849966',
                    timestamp: new Date().toISOString()
                },
                {
                    id: `osint-fr24-${Date.now()}-2`,
                    source_country: 'FLIGHTRADAR24',
                    source_name: 'X.COM / @flightradar24',
                    perspective: 'Western',
                    type: 'flight',
                    raw_content: '7700 EMERGENCY SQUAWK: Commercial flight over Persian Gulf reporting localized engine issues. Diverting to Dubai DXB.',
                    translated_content: '7700 Emergency Squawk over Persian Gulf. Diverting to DXB.',
                    importance_weight: 1.0,
                    url: 'https://x.com/flightradar24/status/2030125153426849967',
                    timestamp: new Date(Date.now() - 300000).toISOString()
                }
            ];

            // Force the most recent FR24 alert to the top
            cachedNews = [...fr24Alerts, ...cachedNews];

            // March 7-8 Specific Tactical Updates + Historical Echoes for Density
            const marchTactical = [
                {
                    id: `tactical-qatar-1`,
                ...
                // Historical Echoes (March 7)
                {
                    id: `echo-tehran-1`,
                    source_country: 'IRAN',
                    source_name: 'OSINT GEOPOL',
                    perspective: 'Global',
                    type: 'kinetic',
                    raw_content: 'Multiple explosions reported near IRGC headquarters in Tehran. Smoke rising from central district.',
                    translated_content: 'Explosions near IRGC HQ, Tehran.',
                ...
                },
                {
                    ...
                    perspective: 'Western',
                    type: 'military',
                    raw_content: 'US Patriot batteries in Qatar engage inbound vectors. Sirens active in Doha port area.',
                    translated_content: 'Patriot engagement over Doha Port.',
                    importance_weight: 0.9,
                    url: 'https://www.reuters.com/world/middle-east/qatar-intercepts',
                    timestamp: '2026-03-07T22:15:00Z'
                },
                {
                    id: `echo-dubai-1`,
                    source_country: 'UAE',
                    source_name: 'OSINT UAE',
                    perspective: 'Western',
                    type: 'kinetic',
                    raw_content: 'Anti-aircraft fire visible over Dubai Marina. Authorities claim drills but residents report sonic booms.',
                    translated_content: 'Anti-aircraft fire over Dubai Marina.',
                    importance_weight: 0.7,
                    url: 'https://www.khaleejtimes.com/uae-drills',
                    timestamp: '2026-03-07T21:45:00Z'
                },
                {
                    id: `echo-beirut-1`,
                    source_country: 'LIVEUAMAP (LEBANON)',
                    source_name: 'OSINT LEBANON',
                    perspective: 'Diverse',
                    type: 'military',
                    raw_content: 'Hezbollah drone activity reported near the Blue Line. IDF artillery responding.',
                    translated_content: 'Hezbollah drone activity near Blue Line.',
                    importance_weight: 0.8,
                ...
                {
                    id: `echo-damascus-1`,
                    source_country: 'LIVEUAMAP (SYRIA)',
                    source_name: 'SANA',
                    perspective: 'Diverse',
                    type: 'kinetic',
                    raw_content: 'Syrian air defenses engaged targets over Damascus southern countryside.',
                    translated_content: 'Engagement over Damascus.',
                    importance_weight: 0.9,
                ...
                {
                    id: `echo-yemen-1`,
                    source_country: 'LIVEUAMAP (YEMEN)',
                    source_name: 'OSINT HOUTHI',
                    perspective: 'Diverse',
                    type: 'kinetic',
                    raw_content: 'Houthi rebels claim successful strike on commercial vessel in Gulf of Aden.',
                    translated_content: 'Houthi strike in Gulf of Aden.',
                    importance_weight: 0.9,
            ...
            if (broadcastHistory.length < 50) {
                const freshHistory = [...cachedNews].slice(0, 100).map(item => ({
                    ...item,
                    isIran: item.source_country === 'IRAN' || item.source_country.includes('IRAN')
                }));
                broadcastHistory = [...freshHistory, ...broadcastHistory].slice(0, 100);
            }
        }
    };
    ...
    setInterval(async () => {
        try {
            // Sort cache by timestamp descending to ensure chronological priority
            cachedNews.sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp));
            ...
            const newItem = {
                ...
                perspective: m.perspective || 'Diverse',
                type: m.type || 'kinetic',
